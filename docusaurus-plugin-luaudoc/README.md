# LuauDoc for Docusaurus

This is the [Docusaurus](https://docusaurus.io/) plugin for using [LuauDoc](https://github.com/0xjwlabs/ldoc). While you can use this package directly, it's recommended to use the LuauDoc CLI, which can be found at the above link.
