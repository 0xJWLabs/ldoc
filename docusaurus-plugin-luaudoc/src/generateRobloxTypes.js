/*****
 * Original function built by 0xJWLabs (https://github.com/0xJWLabs). Used in 0xJWLabs with explicit permission from original author
 *
 * Author: 0xJWLabs (https://github.com/0xJWLabs)
